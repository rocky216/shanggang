...
class dataUpdater {
  ...
  updateData(data) {
    ...
    for (let listenerGuid in this.subscribers) {
      ...
      this.updateDataForSubscriber(listenerGuid, data).then(() => this.requestsPending--).catch(() => this.requestsPending--)
    }
  }
  updateDataForSubscriber(listenerGuid, data) {
    return new Promise((resolve, reject) => {
      ...
      this.onSubscriberDataReceived(listenerGuid, data)
      resolve()
