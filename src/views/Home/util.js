...
export function subData(num, code){
  return {
    MsgID: num,
    MsgBody: {
      instrumentid: code
...
export function CreateStudys(widget){
  widget.chart().createStudy('Moving Average', false, true, [5, "close", 0], null, {'Plot.color': "#dd9d3e"}); // 添加macd线
  widget.chart().createStudy('Moving Average', false, true, [10, "close", 0], null, {'Plot.color': "#6195e9"}); // 添加macd线
}
